    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mLocationListener = new LocationListener() {
			...
			public void onStatusChanged(String provider, int status, Bundle extras) {
				...
				Log.i(TAG, "OnCreate: LocationListener -> onStatusChanged");		
			}
			@Override
			public void onProviderEnabled(String provider) {
				// TODO Auto-generated method stub
				Log.i(TAG, "OnCreate: LocationListener -> onProviderEnabled-------------------");
			}
			@Override
			...
			public void onLocationChanged(Location location) {
				...
				Log.i(TAG, "LocationListener -> onLocationChanged: lng=" + location.getLongitude() + ";lat=" + location.getLatitude()+ ";accuracy=" + location.getAccuracy());
	    ...
	    protected void onPostExecute(List<AccessPointData> result) {
	    	...
	    	if (mMap != null){
	    		...
	    		for(AccessPointData apData: result){
	    			...
	    			//change the icon
	    			BitmapDescriptor icon = BitmapDescriptorFactory.fromResource(R.drawable.markerfibertelzone);
